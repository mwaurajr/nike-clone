...
function Homepage() {
  return (
    <div className='w-full h-screen'>
        <img className='top-0 w-full object-cover h-screen left-0' src='https://images.pexels.com/photos/15435913/pexels-photo-15435913.jpeg?auto=compress&cs=tinysrgb&w=600    ' alt='/'/>
