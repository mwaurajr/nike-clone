...
function Homepage() {
  return (
    <div className='w-full h-screen'>
        <img className='top-0 w-full object-cover h-screen left-0' src='https://images.pexels.com/photos/6692038/pexels-photo-6692038.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/'/>
